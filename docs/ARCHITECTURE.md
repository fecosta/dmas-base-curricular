...
## 20. SPEC-003 local implementation structure
...
- **Deployment boundary:** download requests authorize current access and metadata before issuing a 60-second signed Storage redirect. No service/secret credential is added to the application. The migration and private bucket have not been applied to Cloud in this implementation pass.
